...
ref= "D01"
"""
os.chdir("/home/klogw/1_work/MMPBSA_GUI_ver1.5")
n=1
m=1
...
"""
    x= Decomp("md1","D04").get_dG()
    y= Decomp("md2","D04").get_dG()
    z= Decomp("md3","D04").get_dG()
    name= Decomp("md1","D04").get_name()
    
    print Plot3D(x,y,z).plot_3D(name)
"""

"""
1Dto3Dまで
重ね合わせは
rawdata.csvを参照するクラスを作成すればよい
"""
